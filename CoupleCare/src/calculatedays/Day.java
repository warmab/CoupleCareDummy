...
public class Day implements Serializable {
    ...
    public void calculateFertilesDays() {
        ...
        tempCal.set(Calendar.DAY_OF_MONTH, fertileDay.get(Calendar.DAY_OF_MONTH));
        ...
        // Agrego a la lista el tercer día:
        simpleDatesList.add(new SimpleDate(tempCal.get(Calendar.DAY_OF_MONTH), 
            tempCal.get(Calendar.MONTH), tempCal.get(Calendar.YEAR), DayType.PERIOD));
        ...
        for(; i <= ((freqDayNumber / 2) - 1) - 3; i++) {
            tempCal.add(Calendar.DAY_OF_MONTH, 1);
            simpleDatesList.add(new SimpleDate(tempCal.get(Calendar.DAY_OF_MONTH), 
                tempCal.get(Calendar.MONTH), tempCal.get(Calendar.YEAR), DayType.FERTILE));
        }
        
        tempCal.add(Calendar.DAY_OF_MONTH, 1);
        simpleDatesList.add(new SimpleDate(tempCal.get(Calendar.DAY_OF_MONTH), 
                tempCal.get(Calendar.MONTH), tempCal.get(Calendar.YEAR), DayType.MOSTFERTILE));
        
        tempCal.add(Calendar.DAY_OF_MONTH, 1);
        simpleDatesList.add(new SimpleDate(tempCal.get(Calendar.DAY_OF_MONTH), tempCal.get(Calendar.MONTH), tempCal.get(Calendar.YEAR), DayType.FERTILE));
        ...
        for(int j = 0; j < (freqDayNumber / 2) - 2; j++) {
            tempCal.add(Calendar.DAY_OF_MONTH, 1);
            simpleDatesList.add(new SimpleDate(tempCal.get(Calendar.DAY_OF_MONTH), tempCal.get(Calendar.MONTH), tempCal.get(Calendar.YEAR), DayType.NOFERTILE));
        }
        
        tempCal.add(Calendar.DAY_OF_MONTH, 1);
        fertileDay.set(Calendar.DAY_OF_MONTH, tempCal.get(Calendar.DAY_OF_MONTH));
    ...
    public String toString() {
        return "Day{" + "fertileDay=" + fertileDay.getTime() + ", fertile=" + fertile + ", comment=" + comment + ", color=" + color + '}';
    }
